...
Project.prototype.getTime() {
	return this.time;
}

Project.prototype.addWork(workEntryData) {
...
Project.prototype.getWorkEntryCount() {
	return this.work.length;
}

Project.prototype.getWorkEntryLocation(workEntryId) {
